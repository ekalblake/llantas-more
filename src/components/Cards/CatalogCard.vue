...
<template>
	...
	>
		...
		<h3 class="font-[var(--font-family-heading)] text-lg text-[var(--dark-text-color)] mb-2">
			{{ item.name }}
		</h3>
		...
		<button
			type="button"
			class="mt-auto w-full bg-[var(--primary-color)] text-[var(--primary-button-text-color)] px-5 py-3 rounded-lg font-bold hover:bg-[var(--primary-button-hover-bg-color)] transition-all duration-300 cursor-pointer shadow-md hover:shadow-lg"
			@click="onAdd(item)"
		>
			Agregar
		</button>
